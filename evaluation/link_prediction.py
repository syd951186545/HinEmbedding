...
def main():
    ...
    # embedding_files = [['../data/output/blogCatalog/deepwalk_embedding.model',
    ...
    embedding_files = [
                        ['../data/output/blogCatalog/deepwalk_embedding.model'],
                        ['../data/output/citeseer/deepwalk_embedding.model'],
                        ['../data/output/flickr/deepwalk_embedding.model'],
                        ['../data/output/pubmed/deepwalk_embedding.model']
                       ]

    new_edges = ['../data/sample/blogCatalog.npy',
                 '../data/sample/citeseer.npy',
                 '../data/sample/flickr.npy',
                 '../data/sample/pubmed.npy']
